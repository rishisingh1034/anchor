    ...
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-indigo-500 selection:text-white">
      ...
      <section className="pt-16 pb-12 px-6 text-center max-w-4xl mx-auto space-y-6 relative">
        ...
        <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            href="https://youtu.be/Y5CgQXDM7aY"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-xl border border-red-500/40 bg-red-500/10 px-5 py-3 text-sm font-medium text-red-300 transition hover:bg-red-500/20 hover:text-red-200 hover:border-red-500/60 shadow-sm"
          >
